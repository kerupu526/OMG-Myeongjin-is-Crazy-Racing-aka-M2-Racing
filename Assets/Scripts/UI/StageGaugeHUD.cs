...
namespace M2.UI
{
    ...
    public class StageGaugeHUD : MonoBehaviour
    {
        ...
        void BuildLayout()
        {
            ...
            containerRect.offsetMin = new Vector2(28f, RaceHUD.ScaleGameplayHud(26f));
            containerRect.offsetMax = new Vector2(-28f, RaceHUD.ScaleGameplayHud(104f));
            AddOutline(container, Color.white, new Vector2(2f, -2f));

            titleLabel = CreateText("Title", container.transform, RaceHUD.ScaleGameplayHudFont(22), Color.white, TextAnchor.UpperLeft);
            titleLabel.rectTransform.anchorMin = new Vector2(0f, 1f);
            titleLabel.rectTransform.anchorMax = new Vector2(0.65f, 1f);
            titleLabel.rectTransform.offsetMin = RaceHUD.ScaleGameplayHud(new Vector2(16f, -34f));
            titleLabel.rectTransform.offsetMax = RaceHUD.ScaleGameplayHud(new Vector2(0f, -4f));
            valueLabel = CreateText("Value", container.transform, RaceHUD.ScaleGameplayHudFont(22), new Color(1f, 0.851f, 0.239f), TextAnchor.UpperRight,
                UiFontRole.Metric);
            valueLabel.rectTransform.anchorMin = new Vector2(0.65f, 1f);
            valueLabel.rectTransform.anchorMax = new Vector2(1f, 1f);
            valueLabel.rectTransform.offsetMin = RaceHUD.ScaleGameplayHud(new Vector2(0f, -34f));
            valueLabel.rectTransform.offsetMax = RaceHUD.ScaleGameplayHud(new Vector2(-16f, -4f));
            ...
            barRect.offsetMin = RaceHUD.ScaleGameplayHud(new Vector2(16f, 10f));
            barRect.offsetMax = RaceHUD.ScaleGameplayHud(new Vector2(-16f, 38f));
